...
export default function TournamentsPageShell({
  ...
  const maxUnknownRatio =
    queries.tournamentQueryRef.variables.maxUnknownRatio;
      ...
      <div className="mx-auto mt-8 w-full max-w-(--breakpoint-xl) px-8">
        <div className="mb-8 flex flex-col space-y-4 md:flex-row md:items-end md:space-y-0">
          ...
          <div className="flex flex-wrap items-end gap-x-4 gap-y-2">
            ...
            <Select
              id="tournaments-data-quality"
              label="Data Quality"
              value={maxUnknownRatio ?? ''}
              onChange={(value) => {
                replaceRoute('/tournaments', {
                  maxUnknownRatio: value || undefined,
                });
              }}
            >
              <option value="">Show All</option>
              <option value="0.75">25%+ Known</option>
              <option value="0.5">50%+ Known</option>
              <option value="0.25">75%+ Known</option>
      ...
      @refetchable(queryName: "AllTournamentsQuery") {
        tournaments(
          ...
          filters: {
            ...
            minSize: $minSize
            maxUnknownRatio: $maxUnknownRatio
          }
          sortBy: $sortBy
