import StaplesQuery from '#genfiles/queries/StaplesQuery.graphql.js';
...
export default function CommanderStaples({
  queries,
}: PageProps<'/commander/[commander]#staples'>) {
  const {commander} = usePreloadedQuery(
    graphql`
      query StaplesQuery($commander: String!) @preloadable @throwOnFieldError {
