...
export type CommanderStapleCardsQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"staples_cards">;
  } | null | undefined;
};
export type CommanderStapleCardsQuery = {
  response: CommanderStapleCardsQuery$data;
  variables: CommanderStapleCardsQuery$variables;
};
