...
export default function About() {
  ...
  <div className="w-11/12 flex flex-col flex-grow overflow-auto">
    ...
    <div className="w-11/12 ml-auto mr-auto h-screen flex flex-col dark:text-white p-4 md:px-8 md:py-6 flex flex-col gap-4">
      ...
      <p className="text-2xl mb-4">
        Our site is currently in open beta! Feel free to <a class="font-bold text-bantextner dark:text-text" href="https://github.com/JasonQiu21/cedhtop16/issues" target="_blank">submit an issue</a> if you see a bug or think of a feature you'd like to see. You can also find us <a class="font-bold text-bantextner dark:text-text" href="https://discord.gg/gfpD6EFHGm" target="_blank">on Discord</a>.
      ...
      <p className="text-2xl pb-24">
        If you're a tournament organizer and would like to see your tournaments added to our dataset, contact us! Do note, all Command Tower events are automatically added. Join our <a class="font-bold text-bantextner dark:text-text" href="https://discord.gg/gfpD6EFHGm" target="_blank">Discord server</a> to find us!
      </p>
    </div>
  </div>
