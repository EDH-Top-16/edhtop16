...
export type CommanderStaplesCardEntriesQuery$variables = {
...
export type CommanderStaplesCardEntriesQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"stapleDetails_CardEntries">;
  } | null | undefined;
};
export type CommanderStaplesCardEntriesQuery = {
  response: CommanderStaplesCardEntriesQuery$data;
  variables: CommanderStaplesCardEntriesQuery$variables;
};
