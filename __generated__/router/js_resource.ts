 ...
 * @generated-checksum bf83205958bf1d4394b5391047bfba2ff3f7ae3adb775e14f1f64353f48d4da0
...
const RESOURCE_CONF = {
  ...
  'route(/)': {
    ...
    loader: () =>
      import('../../src/commanders').then((m) => m.CommandersPageShell),
  },
  'm#index': {
    src: 'src/commanders.tsx',
  ...
  'route(/tournaments)': {
    ...
    loader: () =>
      import('../../src/tournaments').then((m) => m.TournamentsPageShell),
  },
  'route(/tournaments)#tournaments': {
    src: 'src/tournaments.tsx',
    loader: () =>
      import('../../src/tournaments').then((m) => m.TournamentsPage),
  },
  'route(/about)': {
