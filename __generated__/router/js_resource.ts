 ...
 * @generated-checksum a653cf62ea96195ced604670c98ba51dca8f00990224fbf2c185454b09e703f6
...
const RESOURCE_CONF = {
  ...
  '/leaderboard': {
    src: 'pastoria/leaderboard/page.tsx',
    loader: () => import('#pastoria/leaderboard/page').then((m) => m.default),
  },
  '/privacy': {
  ...
  '/reports/monthly_seat_winrates': {
    src: 'pastoria/reports/monthly_seat_winrates/page.tsx',
    loader: () =>
      import('#pastoria/reports/monthly_seat_winrates/page').then(
        (m) => m.default,
      ),
  },
