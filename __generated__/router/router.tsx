 ...
 * @generated-checksum ab17c474fea48e2f8b3fb1564a0471147248cdf4a2f3ed13a73b3fbd6ee76a91
...
import {
  schema as leaderboard_EP_schema,
  entrypoint as leaderboard_EP_entrypoint,
} from './leaderboard_page.entrypoint';
import {
  schema as privacy_EP_schema,
  entrypoint as privacy_EP_entrypoint,
} from './privacy_page.entrypoint';
import {
  schema as profile_EP_schema,
  entrypoint as profile_EP_entrypoint,
...
import {
  schema as commander_$commander_EP_schema,
  entrypoint as commander_$commander_EP_entrypoint,
} from './commander_$commander_page.entrypoint';
import {
  schema as reports_country_winrates_EP_schema,
  entrypoint as reports_country_winrates_EP_entrypoint,
} from './reports_country_winrates_page.entrypoint';
import {
  schema as reports_monthly_seat_winrates_EP_schema,
  entrypoint as reports_monthly_seat_winrates_EP_entrypoint,
} from './reports_monthly_seat_winrates_page.entrypoint';
import {
  schema as tournament_$tid_EP_schema,
  entrypoint as tournament_$tid_EP_entrypoint,
...
const ROUTER_CONF = {
  ...
  '/leaderboard': {
    entrypoint: leaderboard_EP_entrypoint,
    schema: leaderboard_EP_schema,
  } as const,
  '/privacy': {
    entrypoint: privacy_EP_entrypoint,
    schema: privacy_EP_schema,
  } as const,
  '/profile': {
    entrypoint: profile_EP_entrypoint,
    schema: profile_EP_schema,
  } as const,
  '/staples': {
  ...
  '/commander/[commander]': {
    entrypoint: commander_$commander_EP_entrypoint,
    schema: commander_$commander_EP_schema,
  } as const,
  '/reports/country_winrates': {
    entrypoint: reports_country_winrates_EP_entrypoint,
    schema: reports_country_winrates_EP_schema,
  } as const,
  '/reports/monthly_seat_winrates': {
    entrypoint: reports_monthly_seat_winrates_EP_entrypoint,
    schema: reports_monthly_seat_winrates_EP_schema,
  } as const,
  '/tournament/[tid]': {
    entrypoint: tournament_$tid_EP_entrypoint,
    schema: tournament_$tid_EP_schema,
  } as const,
} as const;
...
const ROUTE_MAPPING = {
  ...
  '/leaderboard': ROUTER_CONF['/leaderboard'],
  '/privacy': ROUTER_CONF['/privacy'],
  '/profile': ROUTER_CONF['/profile'],
  '/staples': ROUTER_CONF['/staples'],
  '/tournaments': ROUTER_CONF['/tournaments'],
  '/commander/:commander': ROUTER_CONF['/commander/[commander]'],
  '/reports/country_winrates': ROUTER_CONF['/reports/country_winrates'],
  '/reports/monthly_seat_winrates':
    ROUTER_CONF['/reports/monthly_seat_winrates'],
