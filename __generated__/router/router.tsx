 ...
 * @generated-checksum acbfcc45455c15d75e226d7994c303966a3c335611744af78266f148edeaca36
...
import {
  ...
  Queries as privacy_EP_Queries,
  EntryPoints as privacy_EP_EntryPoints,
} from './privacy_page.entrypoint';
import {
  schema as profile_EP_schema,
  entrypoint as profile_EP_entrypoint,
  Queries as profile_EP_Queries,
  EntryPoints as profile_EP_EntryPoints,
...
import {
  ...
  Queries as reports_country_winrates_EP_Queries,
  EntryPoints as reports_country_winrates_EP_EntryPoints,
...
declare global {
  ...
  type PastoriaPageQueries = {
    ...
    ['/privacy']: privacy_EP_Queries;
    ['/profile']: profile_EP_Queries;
    ['/staples']: staples_EP_Queries;
    ['/tournaments']: tournaments_EP_Queries;
    ['/reports/country_winrates']: reports_country_winrates_EP_Queries;
  };

  type PastoriaPageEntryPoints = {
    ['/']: _EP_EntryPoints;
    ['/about']: about_EP_EntryPoints;
    ['/privacy']: privacy_EP_EntryPoints;
    ['/profile']: profile_EP_EntryPoints;
    ['/staples']: staples_EP_EntryPoints;
    ['/tournaments']: tournaments_EP_EntryPoints;
    ['/reports/country_winrates']: reports_country_winrates_EP_EntryPoints;
  };
