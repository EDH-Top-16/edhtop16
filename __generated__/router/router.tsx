 ...
 * @generated-checksum a8701250abaa8f4836127a3b5092f2896d881ce04b481f09b4ae5857655769e5
...
const ROUTER_CONF = {
  ...
  "/tournaments": {
      ...
      schema: z.object({
        hideUnknownWinners: z.pipe(z.nullish(z.pipe(z.string(), z.transform(decodeURIComponent))), z.transform(s => s == null ? undefined : s)),
        minSize: z.pipe(z.nullish(z.coerce.number<number>()), z.transform(s => s == null ? undefined : s)),
                ...
                return {
                  queries: {
                    tournamentQueryRef: {
                      ...
                      variables: {hideUnknownWinners: variables.hideUnknownWinners, minSize: variables.minSize, sortBy: variables.sortBy, timePeriod: variables.timePeriod}
                    }
                    ,
                  }
                  ,
